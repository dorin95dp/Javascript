...
function renderQuiz() {
    ...
    for (i = 0; i < questions.length; i++) {
        document.writeln('<p class="question">' + 
                         ...
                         ' <span id="result_' + 
                         i + 
                         '"><img src="blank.gif" style="border:0" alt="" /></span></p>');
    ...
    document.writeln('<p><input type="submit" value="Show Score" onclick="showScore()" />\
                         <input type="submit" value="Reset Quiz" onclick="resetQuiz(true)" /></p>\
                      <p style="display:none">\
                          <img src="correct.gif" style="border:0" alt="Correct!" />\
                          <img src="incorrect.gif" style="border:0" alt="Incorrect!" /></p>');
}
...
function showScore() {
    let pc, i = 0, correct = 0, incorrect = 0;  // pc - percentage
...
function disableQuestion(classId) {
    let i = 0;
    let alltags = document.all ? document.all : document.getElementsByTagName("*")
